...
from lib.loss_helper import get_pretrain_loss as get_loss
...
class PretrainSolver:
    def __init__(self,
                 ...
                 lr_decay_step: bool = None,
                 lr_decay_rate: bool = None,
                 bn_decay_step: bool = None,
                 bn_decay_rate: bool = None,
    ...
    def _compute_loss(self, data_dict: Dict[str, torch.Tensor]):
        _, data_dict = get_loss(
            data_dict=data_dict, 
            config=self.config, 
            detection=self.detection,
            use_reference=self.reference, 
    ...
    def _dump_log(self, phase):
        log = {
            "loss": ["loss", "ref_loss", "lang_loss", "objectness_loss", "vote_loss", "box_loss","clip_loss"],
