...
class RandomCuboid(object):
    """
    Adapted from 3DTR [https://arxiv.org/abs/2109.08141]
    """
    ...
    def __call__(self, point_cloud, target_boxes, ref_center_label, per_point_labels=None):
        ...
        for _ in range(200):
            ...
            if np.any(ref_center_label < new_pc_min_max[0]) or np.any(ref_center_label > new_pc_min_max[1]):
                continue
