...
-> Copied and modified from: https://github.com/ATR-DBI/ScanQA/blob/main/models/voting_module.py
    -> Which was(Modified from: https://github.com/facebookresearch/votenet/blob/master/models/voting_module.py
"""
